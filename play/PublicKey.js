...
class PublicKey {
   ...
   * @returns {string} A JSON-compatible string representation of the public key.
   */
  toJSON() {
  ...
  /**
   * Creates a PublicKey instance from a JSON-compatible string.
   * @param {string} jsonString - The serialized public key string.
   * @returns {PublicKey} A new PublicKey instance.
   */
  static fromJSON(jsonString) {
    return new PublicKey(jsonString);
  }
